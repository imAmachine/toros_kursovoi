...
def main():
    slicer_image(50, 300)
    gan_model = GANModel(target_image_size=224)
    trainer = GANTrainer(gan_model, OUTPUT_IMAGES_FOLDER_PATH, OUTPUT_MASKS_FOLDER_PATH, WEIGHTS_PATH, epochs=30, batch_size=32, lr_g=0.00015, lr_d=0.000001, load_weights=True)
    trainer.train()
