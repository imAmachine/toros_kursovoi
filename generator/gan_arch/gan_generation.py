...
class GANTrainer:
    def __init__(self, image_path, mask_path, output_path, epochs, batch_size, target_image_size, lr_g, lr_d, load_weights=True):
    ...
    def _prepare_data(self):
        dataset = TIFDataset(image_dir=self.image_path, mask_dir=self.mask_path, image_transform=self.image_transform, mask_transform=self.mask_transform)
